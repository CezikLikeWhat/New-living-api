Feature: I want to test dashboard data
  Background:
  ...
  Scenario: I want to get Dashboard statistics
    When I send "GET" request to "/json/dashboard/92e1b2c3-2c18-4698-a764-6d1a42f650f5"
    Then response payload should be json:
    """
    {
      "numberOfUserDevices": 3,
      "mostPopularUserDevicesType": {
        "type": "Light bulb",
        "quantity": 1
      },
      "numberOfUsersInSystem": 1,
