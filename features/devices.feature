Feature: I want to test devices controller
  Background:
    ...
    And I have a devices in system:
      | id                                   | name                     | device_type     | mac_address       | user_id                              |
      | 0ca28ec2-e9eb-4013-a121-097c380c55bd | Light bulb - living room | Light bulb      | 00:00:00:00:00:00 | 92e1b2c3-2c18-4698-a764-6d1a42f650f5 |
      | 6e2aae94-41fc-4765-b007-46f1994d0beb | Distance sensor - patio  | Distance sensor | 22:22:22:22:22:22 | 92e1b2c3-2c18-4698-a764-6d1a42f650f5 |
      | 36340076-0431-4a95-8444-69cf1f3173ec | Led ring - tv            | Led ring        | e4:5f:01:2b:58:01 | 92e1b2c3-2c18-4698-a764-6d1a42f650f5 |
    And I have user in system


  Scenario: I want to get device information
    When I send "GET" request to "/json/device/get/6e2aae94-41fc-4765-b007-46f1994d0beb"
  ...
  Scenario: I want to delete device
    When I send "DELETE" request to "/json/device/delete/6e2aae94-41fc-4765-b007-46f1994d0beb"
    Then response payload should be json:
    """
    {
      "status": "OK"
  ...
  Scenario: I want to get devices informations
    When I send "GET" request to "/json/devices/92e1b2c3-2c18-4698-a764-6d1a42f650f5"
    Then response payload should be json:
    """
    [
      {
